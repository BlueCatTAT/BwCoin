...
class Huobi{
	...
	public $api_method = '';
	public $req_method = '';
	const ACCESS_KEY = "4ec70031-bbac3716-3d2xc4v5bu-46c5f";
	const ACCOUNT_ID = "";
	const SECRET_KEY = "a439118c-2581d65e-c9db36e4-a5b55";
	...
	*/
	...
	function get_account_balance() {
		$this->api_method = "/v1/account/accounts/".self::ACCOUNT_ID."/balance";
		$this->req_method = 'GET';
		$url = $this->create_sign_url([]);
		return json_decode($this->curl($url));
	}
	...
	*/
	...
	// 获取账户余额
	function get_balance($account_id=self::ACCOUNT_ID) {
